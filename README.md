...
for access this project node,npm and mongodb should install in pc.
 ...
 - then keep this window as it is, and open vuedemo in another terminal tab,and call "npm run serve" after that you may register and login username and password
